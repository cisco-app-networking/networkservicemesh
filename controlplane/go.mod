...
replace (
	...
	github.com/networkservicemesh/networkservicemesh/controlplane/api v0.3.0 => ./api
	...
	github.com/networkservicemesh/networkservicemesh/forwarder/api v0.0.0-00010101000000-000000000000 => ../forwarder/api
	...
	github.com/networkservicemesh/networkservicemesh/sdk v0.0.0-00010101000000-000000000000 => ../sdk
