...
// List lists all NetworkServices in the indexer for a given namespace.
func (s networkServiceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.NetworkService, err error) {
...
// Get retrieves the NetworkService from the indexer for a given namespace and name.
func (s networkServiceNamespaceLister) Get(name string) (*v1alpha1.NetworkService, error) {
